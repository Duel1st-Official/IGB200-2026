...
public class InspectableToursBuilding : MonoBehaviour
{
    // =========================================================
    // REFERENCES
    // =========================================================
    ...
    [SerializeField] private ToursBuildingInspectionUI inspectionUI;
    ...
    private void Awake()
    {
        ...
        {
            toursBuilding =
                GetComponent<ToursBuilding>();

            if (toursBuilding == null)
            {
                toursBuilding =
                    GetComponentInChildren<ToursBuilding>();
            }
        }
    ...
    private void Start()
    {
        ...
        {
            inspectionUI =
                FindFirstObjectByType<ToursBuildingInspectionUI>();
        }
    ...
    private void InspectToursBuilding()
    {
        if (toursBuilding == null)
        {
            ...
            {
                Debug.LogWarning(
                    "InspectableToursBuilding has no ToursBuilding."
                );
            }
        ...
        if (inspectionUI == null)
        {
            ...
            {
                Debug.LogWarning(
                    "No ToursBuildingInspectionUI found."
                );
            }
    ...
    public ToursBuilding GetToursBuilding()
    {
        return toursBuilding;
    }
